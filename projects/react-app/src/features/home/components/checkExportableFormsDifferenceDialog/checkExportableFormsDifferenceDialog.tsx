...
const CheckExportableFormsDifferenceDialog = React.memo(
  (props: Props): JSX.Element => {
    ...
    return (
      <Fragment>
        <Dialog
          className="export-dialog__main"
          open={props.open}
          onClose={() => handleDecideOption(ExportWhich.Cancel)}
        >
          <DialogTitle className="export-dialog__title">
            {Constants.ExportDialogTitle}
          </DialogTitle>
          <DialogContent className="export-dialog__content">
            <DialogContentText className="export-dialog__content-text">
              {Constants.ExportDialogBody}
            </DialogContentText>
          </DialogContent>
          <DialogActions className="export-dialog__actions">
            <Stack direction="row" sx={{ mb: "10px" }} spacing={8}>
              <div className="export-dialog__export-buttons">
                <Button
                  variant="contained"
                  onClick={() => handleDecideOption(ExportWhich.TakeConfigForm)}
                >
              ...
              <div className="export-dialog__export-buttons">
                <Button
                  variant="contained"
                  onClick={() =>
                    handleDecideOption(ExportWhich.TakeResultsForm)
                  }
                >
