export class Constants {
  ...
  public static readonly SuccessionFormulaErrorOnlyReservedWords: string = 'Please structure the succesion only with n variable, rational numbers and operators'
  public static readonly FormulaErrorExpression: string = 'The structure of the expression can not be calculated, please check it'
  public static readonly MatrixCantBeRepresented: string = 'Matrix can not be represented'
  public static readonly ComplexNumbersCantBeRepresented: string = 'Complex numbers can not be represented'
  public static readonly FunctionFormHasErrors: string = 'Function elements have errors, please check them'
  public static readonly differenceParameterArithmeticProgressionFormula: string = 'd'
  public static readonly variableArithmeticProgressionFormula: string = 'n'
  public static readonly initialValueArithmeticProgressionFormula: string = 'n1'
  public static readonly mathArithmeticProgressionFormula: string =
    Constants.initialValueArithmeticProgressionFormula + '+(' + Constants.variableArithmeticProgressionFormula + '-1)*' + Constants.differenceParameterArithmeticProgressionFormula
  ...
  public static readonly IntroduceMathSeries: string = 'Use mathematical succession'
  public static readonly ApplyArithmeticProgression: string = 'Arithmetic progression'
  ...
  public static readonly ImportedDataFromFile: string = 'Imported data from file'
  ...
  public static readonly MaxLengthTableIndex: string = 'Index > table values length'
  public static readonly SelectRowTableToModify: string = 'Please select row to modify'
  ...
  public static readonly OnlyNumbersSeparatedCommas: string = 'Only numbers separated by commas'
  public static readonly GreaterThanFinal: string = 'Must be > than n'
  public static readonly GreaterThanFinalProgression: string = 'Must be > than VAR1'
  ...
  public static readonly VarsMustHaveSameLength: string = 'All variables must have same length'
  ...
  public static readonly MathSeriesPlaceHolderList: string[] = ['(n+1)*(n+2)','n','n*100','(n+5)^2','n^2/n']
  ...
  public static readonly GeneralFunctionReservedWords: string[] = ['*', '/', '(pi)', '(e)', '%', 'cos(', 'cosh(', 'acosh(', 'asinh(', 'sinh(', 'tanh(', 'atanh(', 'log(' , '(', ')', 'sin(', 'tan(', 'atan(', 'asin(', 'acos(', 'sqrt(', '=', '+', '-', '^']
  public static readonly SuccessionFunctionReservedWords: string[] = [...Constants.GeneralFunctionReservedWords, 'n']
  public static readonly defaultFunctionlist: string[] = [ 'cos(x)', 'sin(x)', 'm*x', 'm*x + n', 'a*x^2 + b*x + c + d + c + e +f', 'k/x', 'c*sqrt(a*x+b)', 'a*x+   b*x+  c']
  ...
  public static readonly excededDimensions: string = 'Variable number exceeds 3 dimensions, can not be represented'
  ...
  public static readonly isArithmeticProgressionTxtFormat: string = 'isArithmeticProgression'
  ...
  public static readonly ExportDialogTitle: string = 'Configuration panel data diffier from results table'
  public static readonly ExportDialogBody: string = '¿What will you do?'
  public static readonly ExportDialogExportOnlyConfig: string = 'Export data from config panel'
  public static readonly ExportDialogExportCalculatedFunctionData: string = 'Export data from results table'
  public static readonly CheckConfigDataBeforeExporting: string = 'Please check configuration value errors before exporting'
  public static readonly ReservedVariablesSnackBarActive: string = 'Already used variables can not be declared again, neither reserved words named VAR(number)'
  public static readonly NoVarNumbersFunctionSnackBarActive: string = 'Declaring variables with numbers is not permited'
  public static readonly SpacingIsNotAllowed: string = 'Spacing is not allowed there'
  public static readonly GeneralError: string = 'An unexpected error has occurred'
  public static readonly PleaseDontExceedMaxElementsPerSuccessionSnackBarActive: string = 'Please dont exceed max elements per succesion, maximum is set to 1000'
  public static readonly FillFunctionDialogTitle: string = 'Select which function to fill with the expression'
  public static readonly ModifyPrecission: string = 'Modify floating point precission (Upper rounding applied): '
  public static readonly ModifyTableValues: string = 'Modify non-constant table values by index: '
  public static readonly SelectRowNameTable: string = 'Select row'
  public static readonly EnableTraceBetweenPoints: string = '¿Enable trace between values?'
  public static readonly ExitModeCleanDialogTitle: string = 'If you exit the mode, configuration values will be earsed'
  public static readonly QuotationMarksNotPermited: string = 'Quotation marks not permited'
}
